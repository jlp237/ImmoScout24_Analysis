...
client = pymongo.MongoClient("mongodb://user:pw@dst-shard-00-00-xd93f.mongodb.net:27017,dst-shard-00-01-xd93f.mongodb.net:27017,dst-shard-00-02-xd93f.mongodb.net:27017/test?ssl=true&replicaSet=DST-shard-0&authSource=admin&retryWrites=true&w=majority")
db = client.IMMO_DATA
